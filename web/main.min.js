...
const QryForm={query:"",resp:null,exportType:"",resizeObserver:null,editor:null,editorTheme:"",xhr:null,executing:false,callError:false,reset:()=>{QryForm.query="";QryForm.resp=null;QryForm.currentPage=0;QryExplain.reset();QryInfos.reset();},submitQuery:()=>{QryForm.resp=null;QryForm.currentPage=0;QryForm.query=QryForm.editor.getCode().trim();ConnForm.saveToLocalStorage('lastQuery',QryForm.query);if(!QryForm.query.length){return;}
