    ...
    view: () => {
        return m("div.grid-main", {
            ...
            m("footer.area-footer-content.ml-auto.mr-0.text-x-small",
                m("p", m.trust('<a href="https://github.com/a-le/'+versionInfo.appName+'" target="_blank">'+versionInfo.appName+'</a> &copy; 2024 . Licensed under AGPL. <a href="https://www.gnu.org/licenses/agpl-3.0.html" target="_blank">View License</a>'))
            )
        );
    }
};